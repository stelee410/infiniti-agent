...
- `spriteExpressions.dir`：含 `exp_01.png`…`exp_08.png` 的目录（相对项目根，如 `./live2d-models/luna/expression`）。**设置且路径有效时**仅用 PNG 切换表情，**不再加载** Live2D；与流式 `[Happy]` 等标签及 `emotionParse` 映射一致。
